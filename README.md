...
This branch represents our Go project setup enhanced with Dependency Inversion and Dependency Injection principles. It addresses the issues that we encountered in the [`without_dep_inv` branch](https://github.com/SBTopZZZ-LG/go-dependency-injection/blob/without_dep_inv/README.md#whats-problematic-here) by decoupling high-level modules from low-level implementations.
